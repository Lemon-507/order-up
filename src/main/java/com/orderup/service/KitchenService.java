...
public class KitchenService {
    ...
    private InteractionResult placeOrDrop(
            Player player,
    ...
    private InteractionResult interactWithTable(Player player, Table table, GameMap map) {
        GameItem heldItem = player.getHeldItem();
    ...
    private InteractionResult takeIngredientFromSource(
            Player player,
            InteractionArea area,
            GameMap map
    ) {
    ...
    private Tile findTile(InteractionArea area, GameMap map) {
